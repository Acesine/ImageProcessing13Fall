...
#ifndef __MYDIPFUNCTION_H__
#define __MYDIPFUNCTION_H__
...
int ConnectedComponentLabeling(const unsigned char* src, int *mapping, int SizeI, int SizeJ,int ObjNum, int* labels);
