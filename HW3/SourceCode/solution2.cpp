...
void processA(unsigned char* src1,unsigned char* src2,unsigned char* src3,unsigned char* src4,unsigned char* src5,int Size)
{
    ...
    {
        cout<<"The location you have input is not on any surface!\n";
    }
...
void processB(unsigned char* src1,unsigned char* src2,unsigned char* src3,unsigned char* src4,unsigned char* src5,int Size,int pDensity,int SizeCapture)
{
...
// (C) Rotating Cube
void processC(unsigned char* src1,unsigned char* src2,unsigned char* src3,unsigned char* src4,unsigned char* src5,int Size,int pDensity,int SizeCapture)
{
...
int main()
{
    ...
    // A:
    processA(src1,src2,src3,src4,src5,Size);

    int pDensity = 200;
    int SizeCapture = 200;
    // B:
    //processB(src1,src2,src3,src4,src5,Size,pDensity,SizeCapture); //Change pDensity, output image size = 2*pDensity

    // C:
    //processC(src1,src2,src3,src4,src5,Size,pDensity,SizeCapture);
