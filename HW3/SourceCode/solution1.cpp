...
void processA1()
{
    ...
    delete src;
    delete tar;
    printf("Process A1 ends...\n");
}

void processA1_Reverse()
{
    printf("Process A1 reverse begins...\n");
    ...
    delete src;
    delete tar;
    printf("Process A1 reverse ends...\n");
}
void processA2()
{
    printf("Process A2 begins...\n");
    int Size = 500;
    float center = 1.0*(Size-1)/2;
    ...
    delete src;
    delete tar;
    printf("Process A2 ends...\n");
}
void processA2_Reverse()
{
    printf("Process A2 reverse begins...\n");
    int Size = 500;
    float center = 1.0*(Size-1)/2;
    float centerl = center-1;
    float ed = Size-1;
    ...
    delete src;
    delete tar;
    printf("Process A2 reverse ends...\n");
}

// Part (b):Warping to Pentagon Shape
void processB1()
{
    printf("Process B1 begins...\n");
    ...
    delete src;
    delete tar;
    printf("Process B1 ends...\n");
}
void processB1_Reverse()
{
    printf("Process B1 reverse begins...\n");
    ...
    delete src;
    delete tar;
    printf("Process B1 reverse ends...\n");
}

void processB2()
{
    printf("Process B2 begins...\n");
    ...
    delete src;
    delete tar;
    printf("Process B2 ends...\n");
}
void processB2_Reverse()
{
    printf("Process B2 reverse begins...\n");
    ...
    delete src;
    delete tar;
    printf("Process B2 reverse ends...\n");
}
...
void processC2_Reverse()
{
    printf("Process C reverse begins...\n");
