...
void EdgeDetectionGradient(const unsigned char *src, unsigned char *tar,int SizeI, int SizeJ,int OperatorType,int thres)
{
    ...
    case 0:
    {
        oprow[0] = 0; oprow[1] = 0; oprow[2] = 0;
        oprow[3] = -1; oprow[4] = 1; oprow[5] = 0;
        oprow[6] = 0; oprow[7] = 0; oprow[8] = 0;

        opcol[0] = 0; opcol[1] = 0; opcol[2] = 0;
        opcol[3] = 0; opcol[4] = 1; opcol[5] = 0;
        opcol[6] = 0; opcol[7] = -1; opcol[8] = 0;
        break;
    }
    case 1:
    {
        oprow[0] = 0; oprow[1] = 0; oprow[2] = 0;
        oprow[3] = 0; oprow[4] = 1; oprow[5] = 0;
        oprow[6] = 0; oprow[7] = 0; oprow[8] = -1;

        opcol[0] = 0; opcol[1] = 0; opcol[2] = 0;
        opcol[3] = 0; opcol[4] = 1; opcol[5] = 0;
        opcol[6] = -1; opcol[7] = 0; opcol[8] = 0;
        break;
    }
    case 2:
    {
        oprow[0] = -1; oprow[1] = 0; oprow[2] = 1;
        oprow[3] = -2; oprow[4] = 0; oprow[5] = 2;
        oprow[6] = -1; oprow[7] = 0; oprow[8] = 1;

        opcol[0] = 1; opcol[1] = 2; opcol[2] = 1;
        opcol[3] = 0; opcol[4] = 0; opcol[5] = 0;
        opcol[6] = -1; opcol[7] = -2; opcol[8] = -1;
        break;
    }
    default:;
    }
